...
<table class="table">
  ...
  <?php if (isset($_SESSION[$OJ_NAME.'_'.'administrator'])||isset( $_SESSION[$OJ_NAME.'_'.'password_setter'] )){?>
    <tr>
      <td><center><a class='btn btn-primary btn-sm' href="user_rating.php" target="main"><b><?php echo $MSG_USER."-".$MSG_SETRATING?></b></a></center></td>
      <td><p><?php echo $MSG_HELP_SETRATING?></p></td>
    </tr>
    <tr>
